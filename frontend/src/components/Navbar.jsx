...
const {setShowSearch}=useContext(ShopContext);
  ...
  return (
    <div className='bg-color:black flex items-center justify-between py-5 font-medium '>
    ...
    <Link to='/login'>          <img className='w-5 cursor-pointer' src={assets.profile_icon} alt=""></img>
    </Link>
          <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
              <Link to='/Profile'>              <p className='cursor-pointer hover:text-black'>My Profile</p>
              </Link>
              <Link to="/orders">              <p className='cursor-pointer hover:text-black' >Orders</p>
              </Link>
